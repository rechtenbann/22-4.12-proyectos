  ...
  <div class="container">
    <div class="form-control border-info mb-3">
      <form method="post" enctype="multipart/form-data">
        ...
        <input class="form-control" type="text" placeholder="Ingresar el nombre del producto" aria-label="default input example" name="tipo" required><br>
        ...
        <label for="formFile" class="form-label">Agrega otra foto del producto</label>
        <input class="form-control" type="file" id="formFile" name="secundaria_img" required><br>
