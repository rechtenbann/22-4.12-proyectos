...
btnAgregar.addEventListener('click', e => {
    ...
    div.innerHTML = `<input class="ingredientes" type="text" name="ingredientes" placeholder="Huevos, harina, etc..."span class="input-group-text" id="basic-addon1" required><button onclick="eliminar(this)">-</button>`;
