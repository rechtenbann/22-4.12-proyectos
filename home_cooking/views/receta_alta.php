<div class="container marketing">
    <div>
        <nav aria-label="breadcrumb" style="margin-top: 60px">
            <ol class="breadcrumb">
                <?php
                breadcrumb("Subir una receta", "receta_alta.php");
    ...
    <form class="receta-alta" method="POST" enctype="multipart/form-data">
        <div class="receta-alta-t">
            <h2 class="receta-alta-h1" style="margin-top: 0px; font-weight:bold; font-size:38px; padding-top: 40px;">Nueva receta <i class="fa-solid fa-kitchen-set"></i></h2>
        </div>

        <div class="mb-3">
            <label for="formGroupDescripcion" class="form-label" style="font-weight: bold; font-size: 20px;">Título</label>
            <input name="nombre" type="text" class="form-control" style="margin-bottom: 30px;" maxlength="30" id="formGroupTitulo" placeholder="Título de tu receta.">
        </div>
        <div class="row">
            <div class="col">
                <label for="principal_img" class="form-label" style="font-weight: bold; font-size: 20px;">Imagen Principal</label>
                <input class="form-control" type="file" style="margin-bottom: 30px;" required name="principal_img" id="principal_img">
            </div>

            <div class="col">
                <label for="pais" class="form-label" style="font-weight: bold; font-size: 20px;">País de origen de su receta</label>
                <select name="pais_id" class="form-select" placeholder="Selecciones país de origen">
                    <?php
        ...
        <div class="mb-3">
            ...
            <textarea name="descripcion" maxlength="81" style="margin-bottom: 30px;" class="form-control" placeholder="Cuéntanos sobre tu receta."></textarea>
        </div>

        <div class="mb-3">
            <label for="formGroupDescripcion" class="form-label" style="font-weight: bold; font-size: 20px;">Ingredientes</label>
            <textarea name="ingredientes" class="form-control" style="margin-bottom: 30px;" maxlength="1000" id="formGroupDescripcion" placeholder="Ingredientes de tu receta."></textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="procedimiento" class="form-control" maxlength="4000" id="formGroup" placeholder="Pasos a seguir de la receta."></textarea>
        </div>
