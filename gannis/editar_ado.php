...
if (!isset($_SESSION['usuario'])) {
    ...
    if ($_SESSION['usuario']['rol_id'] != 1 && $_SESSION['usuario']['rol_id'] != 3) {
        header('Location: index.php');
    }
}
...
if (isset($_POST['nombre_org'])) {
    ...
    if ($_POST['prov_org'] != 0) {
        ...
        if ($_POST['bar'] != 0) {
            ...
            if ($_POST['nombre_org'] != $usuario['nombre'] || $_POST['correo_org'] != $usuario['mail'] || $_POST['edad_ado'] != $usuario['edad'] || $_POST['cumpleanios_ado'] != $usuario['cumpleanios']) {
                ...
                edad = '" . $_POST['edad_ado'] . "',
                cumpleanios = '" . $_POST['cumpleanios_ado'] . "'
                WHERE id = " . $usu;
            ...
            header('location: perfil_ado.php?id=' . $usu .'');
        } else {
