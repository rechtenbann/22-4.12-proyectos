...
$query = "DELETE FROM mascotas WHERE id = '$id'"; //consulta que elimina la fila de mascotas cuyo ID coincida con el que se obtuvo
...
header("Location: listado_mascota.php"); //se redirige a pestaña de listado de mascota
