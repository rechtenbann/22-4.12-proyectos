                        ...
                        <div class="col-sm-8">
                            <div class="card-block" id="card">
                                <div class="cabeza">
                                    ...
                                    <button onclick="location.href='editar_admin.php?id=<?php echo $usu ?>'" type="button" class="btn btn-warning"> Editar Perfil </button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <p id="par" class="m-b-10 f-w-600">Querido administrador</p>
                                        <h6 class="text-muted f-w-400">¿Que se siente ser el Nro 1 de la cadena alimenticia?</h6>
                                    </div>
                                </div>
