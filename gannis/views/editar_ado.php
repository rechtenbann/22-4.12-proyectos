                        ...
                        <div class="col-sm-8" id="edit">
                            <div class="card-block" id="card">
                                <div class="cabeza">
                                    ...
                                    <button onclick="location.href='perfil_ado.php?id=<?php echo $usuario['id']; ?>'" type="button" class="btn btn-warning"> Perfil </button>
                                </div>
                                <div class="linea"></div>
                                <form action="editar_ado.php?id=<?php echo $usuario['id'] ?>" method="POST" enctype="multipart/form-data">
                                    <?php if (isset($msj)) { ?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input value="<?php echo $usuario['edad'] ?>" name="edad_ado" type="text" class="form-control form-control2" placeholder="Edad" required>

                                        </div>
                                        <div class="col-sm-6">
                                            <p id="par" class="m-b-10 f-w-600">Cumpleaños</p>
                                            <input value="<?php echo $usuario['cumpleanios'] ?>" name="cumpleanios_ado" type="date" class="form-control form-control2" required>
