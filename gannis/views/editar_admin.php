                        ...
                        <div class="col-sm-8" id="edit">
                            <div class="card-block" id="card">
                                <div class="cabeza">
                                    ...
                                    <button onclick="location.href='perfil_admin.php?id=<?php echo $usuario['id'] ?>'" type="button" class="btn btn-warning"> Perfil </button>
                                </div>
                                <div class="linea"></div>
                                <form action="editar_admin.php?id=<?php echo $usuario['id'] ?>" method="POST" enctype="multipart/form-data">
                                    <?php if (isset($msj)) { ?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input value="<?php echo $usuario['nombre'] ?>" name="nombre_admin" type="text" placeholder="Nombre de la adminanización" class="form-control form-control2" required>

                                        </div>
                                        <div class="col-sm-6">
                                            <p id="par" class="m-b-10 f-w-600">Email</p>
                                            <input value="<?php echo $usuario['mail'] ?>" name="correo_admin" type="email" placeholder="Mail de la adminanización" class="form-control form-control2" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <select class="form-select" id="lista1" name="prov_admin">
                                                ...
                                                foreach ($provincias as $prov) {
                                                    if (isset($_POST['prov_admin']) || isset($_POST['provincia'])) {
                                                        if ($prov['id'] == $_POST['prov_admin']) { ?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input value="<?php echo $usuario['telefono'] ?>" name="celular" type="text" placeholder="Número de telefono de la adminanización" class="form-control form-control2"  required>
