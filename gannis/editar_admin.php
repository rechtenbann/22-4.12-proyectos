...
if (isset($_POST['nombre_admin'])) {
    ...
    if ($_POST['prov_admin'] != 0) {

        if ($_POST['bar'] != 0) {

            $qry = "UPDATE usuarios SET 
            provincia_id =  '" . $_POST['prov_admin'] . "',
            barrio_id = '" . $_POST['bar'] . "'
            WHERE id = " . $usu;
            ...
            if ($_POST['nombre_admin'] != $usuario['nombre'] || $_POST['correo_admin'] != $usuario['mail'] || $_POST['edad_ado'] != $usuario['edad'] ||  $_POST['celular_admin'] != $usuario['telefono']) {

                $qry = "UPDATE usuarios SET 
            nombre =  '" . $_POST['nombre_admin'] . "',
            mail = '" . $_POST['correo_admin'] . "',
