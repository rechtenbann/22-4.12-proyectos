...
include("config.php");
    ...
    $selectBarrio = "SELECT prov FROM organizaciones WHERE id = (SELECT MAX(id) FROM organizaciones)";
...
<select name="barr" class="form-select" REQUIRED> <!--Seleccion del barrio-->
        ...
        case "Seleccione su provincia"/*0*/: ?>
            <html>
                <head>
                    ...
                    <meta http-equiv="Refresh" content="3;url=registro_organizacion_de_adopcion1.php">
                </head>

                <body>
                    <p> seleccione una provincia, se te va a redirigir automáticamente, en caso contrario, click <a href="registro_organizacion_de_adopcion1.php">aquí</a></p>
                </body>
            </html> <?php
        break;
        case "Bs As"/*1*/:
